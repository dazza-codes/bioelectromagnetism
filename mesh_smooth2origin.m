function FV = mesh_smooth2origin(FV,origin,attract),

% mesh_smooth2origin - smooth vertices of a mesh toward origin
%
...
%
% origin        - 1x3 row vector, default = (0,0,0)
%
% attract       - how much to align the mesh vertices, percent 0:1;
%                 currently not implemented, effectively 1
%
% This function moves each vertex toward the origin.  The amount of
% movement is adjusted to the mean distance from the origin of neighbour
% vertex locations.
%

% $Revision: 1.1 $ $Date: 2007/02/23 05:41:13 $
