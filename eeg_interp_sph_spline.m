function [FV,C] = eeg_interp_sph_spline(Zi,Ei,FV)

% eeg_interp_sph_spline - Spherical Spline Interpolation of Potential
%
% Useage: [FV,C] = eeg_interp_sph_spline(Zi,Ei,FV)
%
...
%       The default is: FV = sphere_tri('ico',3,r);
%
...
% $Revision: 1.3 $ $Date: 2007/02/16 01:24:25 $
...
C = eeg_interp_sph_spline_c(Zi,Gx);
clear Gx
