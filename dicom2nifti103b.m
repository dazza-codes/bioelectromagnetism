function error = dicom2Nifti102 (input_pathname, output_pathname , handles)
%
%
...
single_file_nifti = 1; %This will create a single uncompress .nii file
single_file_nifti_compress = 1; %This will take .nii file and convert to .nii.gz
...
double_file_nifti = 0; %turn off the above output
...
for series = 1 : max_series
    ...
    images_to_dump = images_in_this_series(index);
    
    
    if (isempty(images_to_dump))
        %Empty series
...
if (double_file_nifti == 1)
    ...
    disp('Deleteing .hdr and .img files');
    delete(fname);
