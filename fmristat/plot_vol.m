function m=plot_vol(input_file_x,input_file_y,xlims,ylims,...
   mask_file,mask_thresh,nx,ny)

%PLOT_VOL scatter plot of one volume versus another.
%
% M = PLOT_VOL( INPUT_FILE_X, INPUT_FILE_Y, XLIMS, YLIMS, ...
%                  [MASK_FILE, MASK_THRESH [, NX NY]])
%
...
subplot(2,2,2)
plot(xl,m*yl'./sum(m,2),xl*m./sum(m,1),yl); 
