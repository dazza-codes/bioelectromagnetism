...
statusStringAdd(statusHandle,'Internal nodes found. Defining perimeters.');
...
% Find out the differences between the 2D and 3D node neighbours
...
l1GNodeCoordsN=l1GNodeCoords-1; % Use this -1 to bring them into perfect alignment
