function save_tiff(file,F, res)

% save_tiff - Save figure to TIFF file
% 
% Usage: save_tiff(file,F,res)
% 
% 'file'    - the string filename
% 'F'       - a figure handle, when empty uses 'gcf'
% 'res'     - resolution, 600 dpi default
% 
% Outputs Tagged Image Format (600 dpi)
% 

% $Revision: 1.1 $ $Date: 2006/05/12 01:01:05 $
